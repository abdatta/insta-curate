...
export function PostCard({ post, rank, onCommentPosted }: PostCardProps) {
  ...
  return (
    <article
      class={`post-card ${collapsed ? 'collapsed' : ''} ${isSeen ? 'seen-card' : ''}`}
    >
      ...
      <div
        class={`collapsible-wrapper ${collapsed ? 'collapsible-hidden' : 'collapsible-visible'}`}
      >
                    ...
                    <div class="suggestion-buttons">
                      ...
                      <button
                        ...
                        onClick={async () => {
                          ...
                          window.instaCurateBusy = true;
                          try {
                            const result = await api.generateComments(
                              post.shortcode,
                              context
                            );
