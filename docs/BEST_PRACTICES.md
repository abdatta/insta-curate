...
- **Format**:
    ...
    2.  **Body**: Bullet points explaining *what* and specifically *why*.
...
- **ADRs**: If you make a decision that affects *how* we build (e.g., "Switching from SQLite to DuckDB"), create an ADR in `docs/adr/`.
